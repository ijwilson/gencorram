...
The first thing we do is to load the library.  For now we don't require any other libraries.
...
```{r pheno_plot1}
pheno_females_A <- calculate_phenotype(eff = effects_A, genotype = females)
pheno_females_B <- calculate_phenotype(eff = effects_B, genotype = females)
pheno_males_A <- calculate_phenotype(eff = effects_A, genotype = males)
pheno_males_B <- calculate_phenotype(eff = effects_B, genotype = males)
...
child_pheno_A <- calculate_phenotype(eff = effects_A, genotype = child)
child_pheno_B <- calculate_phenotype(eff = effects_B, genotype = child)
```
